...
document.getElementById( 'button' ).addEventListener( 'click', e => {
  __webpack_require__.e/* System.import */(1).then(__webpack_require__.bind(null, 1)).then( MerryXmas => {
    if (!this.merryXmas) {
  ...
  constructor() {
    __WEBPACK_IMPORTED_MODULE_0_alertify_js___default.a
      ...
      .confirm("I am learning how to lazy load", function (ev) {
          ...
          __WEBPACK_IMPORTED_MODULE_0_alertify_js___default.a.error("Don't be negative, you can do it, I know it!");
...
>>>>>>> 8aa040e... eliminating default export

setTimeout(() => {
  __webpack_require__.e/* System.import */(0).then(__webpack_require__.bind(null, 0)).then(Alert => {
    new Alert.default();
  })
}, 5000);
